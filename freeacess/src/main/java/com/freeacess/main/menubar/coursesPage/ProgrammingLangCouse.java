...
public class ProgrammingLangCouse extends JFrame {
    ...
    public ProgrammingLangCouse() {

        super("Linguagem de Programação");
        setIconImage(Toolkit.getDefaultToolkit().getImage(
                "freeacess\\src\\main\\java\\com\\freeacess\\icons\\progra(1).jpg"));
        setLayout(null);
    ...
    private void GUI() {
        ...
        list_path_videos = vp.getPathVideosFromDB("programming");
        ...
        label.setBounds(label_icon.getX() - 75, label_icon.getY() + 110, 300, 120);
        label.setText(
                "<html><p text-align:center;>O curso de Linguagens de programação é um curso para você que quer começar a aprender alguma linguagem de programação, ou busca aprender outras linguagens para te auxiliar no dia a dia de desenvolvimento de softwares.</p> <p text-align:center;>Se você está procurando se aprofundar nessa área esse é o lugar certo para você.</p>");
        panel.add(label);
        ...
        button.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ProgrammingLangCouse.this.dispose();
